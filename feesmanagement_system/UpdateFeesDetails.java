 ...
 /*if(ddno.getText().equals("")){
  ...
  String UpdateData() {
    ...
    try {
        ...
        String sql = "UPDATE fees_detail SET payment_mode=?, rollno=?, student_name=?, bank_name=?, dd_no=?, year1=?, year2=?, course=?, gstin=?, total_amount=?, date=?, amount=?, cgst=?, sgst=?, remark=?, totalinwords=? WHERE reciept_no=?";

        PreparedStatement smt = con.prepareStatement(sql);

        smt.setString(1, paymode.getSelectedItem().toString());
        smt.setString(2, txtroll.getText());
        smt.setString(3, txtrecivefrom.getText());
        smt.setString(4, txtbankname.getText());
        smt.setString(5, ddno.getText());
        smt.setString(6, txtyear1.getText());
        smt.setString(7, txtyear2.getText());
        smt.setString(8, jComboBox2Course.getSelectedItem().toString());
        smt.setString(9, gstin.getText());
        smt.setString(10, jTextFieldamt1.getText());
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String date = dateFormat.format(jDateChooser2.getDate());
        smt.setString(11, date);
        smt.setString(12, jTextFieldamt4.getText());
        smt.setString(13, jTextFieldamt2.getText());
        smt.setString(14, jTextFieldamt3.getText());
        smt.setString(15, jTextArea1remark.getText());
        smt.setString(16, totalinwords.getText());
        smt.setInt(17, Integer.parseInt(txtrecipteno.getText()));  // Assuming reciept_no is an integer
  ...
  public void setRecord() {
    try {
        ...
        if (rst.next()) {
            ...
            paymode.setSelectedItem(rst.getString("payment_mode"));
            txtrecivefrom.setText(rst.getString("student_name"));
                   txtbankname.setText(rst.getString("bank_name"));
            ddno.setText(rst.getString("dd_no"));
     
            
            txtyear1.setText(rst.getString("year1"));
            txtyear2.setText(rst.getString("year2"));
            jComboBox2Course.setSelectedItem(rst.getString("course"));
            gstin.setText(rst.getString("gstin"));
            jTextFieldamt1.setText(rst.getString("total_amount"));
            jDateChooser2.setDate(rst.getDate("date"));
            txtroll.setText(rst.getString("rollno"));
            txthead.setText(rst.getString("course"));
            jTextFieldamt4.setText(rst.getString("amount"));
            jTextFieldamt2.setText(rst.getString("cgst"));
            jTextFieldamt3.setText(rst.getString("sgst"));
            jTextArea1remark.setText(rst.getString("remark"));
            totalinwords.setText(rst.getString("totalinwords"));
            txtrecipteno.setText(rst.getString("reciept_no"));
        }
